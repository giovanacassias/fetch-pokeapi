...
async function submitHandler() {
  try {
    ...
    const data = await pokemonService.fetchData(pokemonInput);
...
async function addPokemonFavorite() {
  try {
    ...
    const pokemonInput = document.getElementById("pokemon-name").value;
    ...
    //chamar função de adicionar à local storage passando 'pokemon' como argumento
...
document.getElementById("icon-heart").addEventListener("click", submitHandler);
